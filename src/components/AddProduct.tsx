        ...
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-purple-100 to-purple-300">
            ...
            >
                ...
                <div className="flex flex-col space-y-4 w-full">
                    ...
                    <select {...register("unit", { required: "Unit is required" })} className="border p-2 rounded w-full">
                    ...
                    <select {...register("warranty", { required: "Warranty is required" })} className="border p-2 rounded w-full">
                    ...
                    <select {...register("category", { required: "Category is required" })} className="border p-2 rounded w-full">
                    ...
                    <select {...register("subcategory", { required: "Sub-category is required" })} className="border p-2 rounded w-full">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className={`bg-purple-800 hover:bg-purple-700 text-white p-3 rounded w-full shadow ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
                >
                    {loading ? "Saving..." : "Save"}
                </button>
            </form>
